class Controlador {
    ...
    fun registrarSolicitud() {
        ...
        println("Ingrese el ID para la Mudanza:")
        val idSolicitud = readln().toInt()
        println("Asigne los Repartidores a la Mudanza:")
        val repartidor = readln()
        println("Ingrese la Dirección del Destino:")
        val direccionDestino = readln()
        println("Ingrese la Fecha de la Mudanza(00/00/00/):")
        ...
        val nuevaSolicitud = Solicitud( clienteSolicitud, idSolicitud, repartidor, direccionDestino, fechaDeMudanza, totalMuebles, costeMudanza, valorPorMueble
        )
        listaSolicitudes.add(nuevaSolicitud)
        println("Solicitud Registrada Correctamente.")
    }
    ...
    fun registrarRepartidor() {
        ...
        println("Repartidor registrado correctamente")
    }
    fun mostrarSolicitudes() {
        if (listaSolicitudes.isEmpty()) {
            ...
            listaSolicitudes.forEach { solicitud ->
                ...
                println("Costo total de la Mudanza:...............${solicitud.costeMudanza}")
            }
        }
    }
